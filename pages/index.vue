      ...
      <v-col cols="12" xs="12" sm="12" md="6" lg="6">
        <v-lazy>
          <TotalBarChart
            ...
            :horizontal="true"
            :showDataLabel="false"
            :title="$t('Cases by Woreda (Top 20)')"
    ...
    <v-row>
      ...
      <v-col cols="4" xs="12" md="6">
        <v-lazy>
          <v-card elevation="0" hover tile style="height: 510px;">
            <v-card-title
              >Outcome Status<span class="index__pie_chart_percentage_label">{{
                finalOutcomePercentage
                  ? ` ${finalOutcomePercentage}% Deceased`
                  : ""
              }}</span></v-card-title
            >
            <PieChart
